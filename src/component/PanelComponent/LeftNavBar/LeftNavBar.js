...
export default function LeftNavBar({history}){
    const dispatch = useDispatch();
   
    return(
        <div className="navigation navbar navbar-light bg-primary">
            <Link to="/@me" className="d-none d-xl-block bg-light rounded p-1">
            ...
            <ul className="nav nav-minimal flex-row flex-grow-1 justify-content-between flex-xl-column justify-content-xl-center" id="mainNavTab" role="tablist">
                ...
                <li className="nav-item">
                    <Link to="/@me" className="nav-link p-0 py-xl-3 active" id="chats-tab" href="#chats-content" title="Chats">
                ...
                <li className="nav-item">
                    <Link to="/profile" className="nav-link p-0 py-xl-3"  title="Profile">                    
                        <svg className="hw-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
